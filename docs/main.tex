...
two-dimensional convolution, the generic adapter module has an analogous branch, but
Bolero's Borzoi architecture uses only one-dimensional convolutions over genomic position;
the Conv2d branch is not used by this model.
